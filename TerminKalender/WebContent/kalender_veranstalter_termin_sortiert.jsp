...
<label for="sortw"></label>
  <select id="sortw" class="form-control" name="dropdownSort">
...
<% 
	...
	ArrayList<Termin> terminList = (ArrayList<Termin>)request.getSession().getAttribute("terminlistVerSort");
	if(kalenderList.isEmpty()){
	}else{
			for(int i=0; i<terminList.size();i++){
				Termin t = terminList.get(i);
				%>
				<br>
