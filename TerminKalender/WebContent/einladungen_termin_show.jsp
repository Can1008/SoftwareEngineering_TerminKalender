...
<% 
	...
	String KalenderNumb = (String)session.getAttribute("KalenderNumber");
	int test = Integer.parseInt(KalenderNumb);
	Kalender cal = man.getKalenderById(test);
	String username = request.getSession().getAttribute("loggedInPrivate").toString();
	SimpleDateFormat sdf = new SimpleDateFormat("dd.MM.yyyy, HH:mm"); 
	ArrayList<Termin> liste = cal.getTerminlist();
	...
	if(liste == null){
		...
		RequestDispatcher rd = request.getRequestDispatcher("einladungen_termin_show.jsp");
		rd.forward(request, response);
	}
			%>
